...
const channels = [
  ...
  { icon: "✈", name: "텔레그램 알림 봇", handle: "@onehub_jiy_bot", desc: "매매 신호, 일일 리포트, 엔진 상태 알림을 실시간으로 수신", status: "LIVE", action: "채널 참여", link: "https://t.me/onehub_jiy_bot" },
...
const principles = [
  ...
  { icon: "欄", title: "AI + 사람의 협업", desc: "AI 판단 근거와 사람의 최종 결정 과정을 콘텐츠화." },
...
function NewsletterForm() {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} style={{ marginTop: "12px" }}>
      ...
      {status === "error" && <p style={{ fontFamily: "monospace", fontSize: "10px", color: "#DD3333", marginTop: "6px" }}>오류가 발생했습니다. 다시 시도해 주세요.</p>}
