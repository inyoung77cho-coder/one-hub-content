  ...
  const channels = [
    {
      icon: "✈️",
      name: "텔레그램 알림 봇",
      handle: "@onehub_jiy_bot",
      desc: "매매 신호, 일일 리포트, 엔진 상태 알림을 실시간으로 수신",
      status: "LIVE",
      action: "채널 참여",
      link: "https://t.me/onehub_jiy_bot",
    },
    {
      icon: "📧",
      name: "뉴스레터",
      handle: "Weekly Digest",
      desc: "매주 금요일 — 주간 운영 성과 + AI 인사이트 요약 이메일 발송",
      status: "BUILDING",
      action: "준비 중",
      link: null,
    },
    {
      ...
      name: "카카오 알림",
      handle: "KakaoTalk",
      desc: "중요 매매 신호 및 리스크 경고를 카카오톡으로 수신",
      status: "BUILDING",
      action: "준비 중",
      link: null,
    },
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            ...
            <nav style={{ display: "flex", gap: "20px" }}>
              {[["DAILY","/daily"],["WEEKLY","/weekly"],["ENGINES","/engines"],["STRATEGIES","/strategies"],["COMMUNITY","/community"],["ABOUT","/about"]].map(([label, href]) => (
                <Link key={href} href={href} style={{ fontFamily: "monospace", fontSize: "11px", color: href === "/community" ? "#00d084" : "#4a5568", textDecoration: "none", letterSpacing: "0.1em" }}>{label}</Link>
              ))}
            </nav>
          </div>
        </header>
