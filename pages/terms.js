  ...
  return (
    <>
      ...
      <main className="doc">
        ...
        <h2>제1조 (목적)</h2>
        <p>본 약관은 ONE·HUB(이하 “서비스”)의 이용 조건과 이용자·OneHub의 권리·의무를 정합니다.</p>
        ...
        <p>OneHub는 베타 서비스의 정확성·완전성·연속성을 보증하지 않으며, 서비스 이용 또는 투자 판단으로 인한 손해에 대해 관련 법령이 허용하는 범위에서 책임을 지지 않습니다. 투자 관련 유의사항은 <Link href="/disclaimer">투자 유의사항·면책 고지</Link>를 따릅니다.</p>

        <h2>제7조 (서비스의 변경 · 중단)</h2>
        <p>OneHub는 서비스의 전부 또는 일부를 변경·중단할 수 있으며, 베타 단계에서는 사전 고지 없이 데이터가 초기화되거나 기능이 조정될 수 있습니다. 중대한 변경은 가능한 범위에서 사전 고지합니다.</p>

        <h2>제8조 (개인정보)</h2>
        <p>개인정보의 처리는 <Link href="/privacy">개인정보 처리방침</Link>에 따릅니다.</p>

        <h2>제9조 (약관의 변경)</h2>
        <p>OneHub는 필요 시 약관을 변경할 수 있으며, 변경 시 시행일과 내용을 서비스 내 고지합니다. 변경 후 계속 이용하는 경우 변경 약관에 동의한 것으로 봅니다.</p>
