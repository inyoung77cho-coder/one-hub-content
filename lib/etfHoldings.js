...
export function getOtherAssets(trader = "A") {
  return readOther()
    ...
    .map((o) => ({ ...o, account: normalizeAccount(o.account || "일반") }));
}
export function addOtherAsset({ name, account = "일반", valueKrw, costKrw, isCash = false, trader = "A" }) {
  ...
  list.push({
    ...
    name: nm, account: acct, valueKrw: val, isCash: !!isCash,
