...
export const TAX_ACCOUNTS = ["일반", "개인연금", "퇴직연금", "ISA"];

// 연금 세액공제 합산 한도(개인연금+IRP 합산, 원)
export function pensionCreditLimitCombined() {
  return acctRule("퇴직연금").tax_credit_limit_won || 9000000;
}
